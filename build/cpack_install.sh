...
# Install the project:
DESTDIR=${DESTDIR}/usr/WorkDir/21.3.5 \
    make -k install/fast

# Remove the .dbg files from being packaged, in case we are in RelWithDebInfo
# build mode:
rm -f ${DESTDIR}/usr/WorkDir/21.3.5/InstallArea/x86_64-centos7-gcc62-opt/bin/*.dbg
rm -f ${DESTDIR}/usr/WorkDir/21.3.5/InstallArea/x86_64-centos7-gcc62-opt/lib/*.dbg
