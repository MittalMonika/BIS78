...
if( NOT WorkDir_FIND_QUIETLY )
   message( STATUS "Found WorkDir: "
      "${WorkDir_ROOT_DIR} (version: 21.3.5)" )
endif()
...
set( WorkDir_BASE_PROJECTS Athena;21.3.5 )
...
set( WorkDir_PACKAGE_NAMES IdDictParser;MuonReadoutGeometry;MuonG4SD;MuonGeoModel;MuonIdHelpers;MuonSimEvent )
...
if( WorkDir_FIND_COMPONENTS )
   ...
   if( ATLAS_RELEASE_RECOMPILE )
      ...
      set( WorkDir_TARGET_NAMES IdDictParserPkg;IdDictParserPkgPrivate;IdDictParser;tid;test_det_id;MuonReadoutGeometryPkg;MuonReadoutGeometryPkgPrivate;MuonReadoutGeometry;MuonG4SDPkg;MuonG4SDPkgPrivate;MuonG4SD;MuonGeoModelPkg;MuonGeoModelPkgPrivate;MuonGeoModelLib;MuonGeoModel;MuonIdHelpersPkg;MuonIdHelpersPkgPrivate;MuonIdHelpersLib;MuonIdHelpers;test_muon_id;MuonSimEventPkg;MuonSimEventPkgPrivate;MuonSimEvent )
